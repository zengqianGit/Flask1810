...
def avatar_add():
    ...
    # p1 = os.path.abspath(os.path.dirname(os.path.dirname(p)))
    # path = os.path.join(p1, filename)

    file.save(path)
    # file.save(r'D:\Web11\class21\web21_1\images\{}'.format(filename))
    # file.save(r'web21_1\images\{}'.format(filename))
    # file.save('D:\Web11\class21\web21_1\images\{}'.format(filename))
